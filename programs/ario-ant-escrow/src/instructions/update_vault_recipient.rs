...
use crate::{
    error::EscrowError,
    events::ASSET_TYPE_VAULT,
    state::{
        derive_rotated_nonce, validated_protocol_and_len, EscrowToken, ESCROW_VAULT_SEED,
...
pub fn handler(
    ...
    msg!(
        "escrow: vault recipient updated asset_id={} new_protocol={}",
        asset_id_pubkey,
...
#[derive(Accounts)]
pub struct UpdateVaultRecipient<'info> {
